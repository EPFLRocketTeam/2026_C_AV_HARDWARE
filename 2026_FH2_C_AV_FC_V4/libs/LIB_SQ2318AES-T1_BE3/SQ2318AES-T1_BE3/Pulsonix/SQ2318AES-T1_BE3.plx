...
(library Library_1
	...
	(symbolDef "SQ2318AES-T1_BE3" (originalName "SQ2318AES-T1_BE3")
	...
	(compDef "SQ2318AES-T1_BE3" (originalName "SQ2318AES-T1_BE3") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "SQ2318AES-T1_BE3"))
		...
		(attr "Mouser Part Number" "78-SQ2318AES-T1_BE3")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Vishay-Siliconix/SQ2318AES-T1_BE3?qs=TiOZkKH1s2QuMGPo0iDprw%3D%3D")
		(attr "Manufacturer_Name" "Vishay")
		(attr "Manufacturer_Part_Number" "SQ2318AES-T1_BE3")
		(attr "Description" "MOSFET N-CHANNEL 40V (D-S)")
		(attr "<Hyperlink>" "https://www.mouser.co.uk/datasheet/2/427/sq2318aes-1764491.pdf")
		(attr "<Component Height>" "1.12")
		(attr "<STEP Filename>" "SQ2318AES-T1_BE3.stp")
