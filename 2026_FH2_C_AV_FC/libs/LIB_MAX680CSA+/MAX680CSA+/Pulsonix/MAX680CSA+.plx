...
(library Library_1
	...
	(symbolDef "MAX680CSA+" (originalName "MAX680CSA+")
	...
	(compDef "MAX680CSA+" (originalName "MAX680CSA+") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "C1+") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MAX680CSA+"))
		...
		(attr "Mouser Part Number" "700-MAX680CSA")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices-Maxim-Integrated/MAX680CSA%2b?qs=1THa7WoU59GmJru%252B3pd8uQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "MAX680CSA+")
		(attr "Description" "Charge Pump INV/STPUP  10V 10mA")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-18/DSA-340121.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MAX680CSA+.stp")
