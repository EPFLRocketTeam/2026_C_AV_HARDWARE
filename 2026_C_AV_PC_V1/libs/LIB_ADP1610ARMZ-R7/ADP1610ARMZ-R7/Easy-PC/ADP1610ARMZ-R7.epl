...
(library Library_1
	...
	(compDef "ADP1610ARMZ-R7" (originalName "ADP1610ARMZ-R7") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "8" (pinName "SS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "RT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "IN") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "SW") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://www.analog.com/media/en/technical-documentation/data-sheets/ADP1610.pdf")
		(attr "Height" "1.1 mm")
	)
