...
//13920398/1515570/2.50/8/0/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ADP1610ARMZ-R7" (originalName "ADP1610ARMZ-R7")
	...
	(compDef "ADP1610ARMZ-R7" (originalName "ADP1610ARMZ-R7") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "COMP") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "8" (pinName "SS") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "7" (pinName "RT") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "IN") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "SW") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ADP1610ARMZ-R7"))
		...
		(attr "Mouser Part Number" "584-ADP1610ARMZ-R7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/ADP1610ARMZ-R7?qs=WIvQP4zGanjTQwiTj85NkQ%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "ADP1610ARMZ-R7")
		(attr "Description" "Switching Voltage Regulators 1.2 MHz PWM Boost Switching Regulator")
		(attr "<Hyperlink>" "https://www.analog.com/media/en/technical-documentation/data-sheets/ADP1610.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "ADP1610ARMZ-R7.stp")
