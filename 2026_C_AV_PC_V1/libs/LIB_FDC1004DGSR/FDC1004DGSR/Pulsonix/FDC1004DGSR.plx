...
//269755/1515570/2.50/10/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "FDC1004DGSR" (originalName "FDC1004DGSR")
	...
	(compDef "FDC1004DGSR" (originalName "FDC1004DGSR") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "SHLD1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "2" (pinName "CIN1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "3" (pinName "CIN2") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "4" (pinName "CIN3") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "5" (pinName "CIN4") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "10" (pinName "SDA") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "SCL") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Input))
		(compPin "8" (pinName "VDD") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "7" (pinName "GND") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "6" (pinName "SHLD2") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Input))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "FDC1004DGSR"))
		...
		(attr "Mouser Part Number" "595-FDC1004DGSR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/FDC1004DGSR?qs=zEQ6BYqA5vF%252BEdgfKNFEaA%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "FDC1004DGSR")
		(attr "Description" "4 Channel Capacitance to Digital Converter for Capacitive Sensing (Cap Sensing) Solutions")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/fdc1004")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "FDC1004DGSR.stp")
