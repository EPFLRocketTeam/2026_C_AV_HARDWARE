...
//821810/1515570/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "MCP1642D-50I_MS" (originalName "MCP1642D-50I_MS")
	...
	(compDef "MCP1642D-50I_MS" (originalName "MCP1642D-50I_MS") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "SGND") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "PGND") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "SW") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP1642D-50I_MS"))
		...
		(attr "Mouser Part Number" "579-MCP1642D-50I/MS")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology-Atmel/MCP1642D-50I-MS?qs=kUzwwg2uGjVoXH8JFWZOdQ%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "MCP1642D-50I/MS")
		(attr "Description" "Switching Voltage Regulators Step-up DC/DC Reg 1 MHz, 1.6A, 5Vout")
		(attr "<Hyperlink>" "http://www.microchip.com/mymicrochip/filehandler.aspx?ddocname=en572899")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "MCP1642D-50I_MS.stp")
