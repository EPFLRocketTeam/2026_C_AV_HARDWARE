...
(library Library_1
	...
	(patternDef "43045-06(00,01,02,10)" (originalName "43045-06(00,01,02,10)")
		(multiLayer
			...
			(pad (padNum 7) (padStyleRef c300_h300) (pt -3, -4.32) (rotation 90))
		)
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0, 0) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -9.325 3.52) (pt 3.325 3.52) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.325 3.52) (pt 3.325 -8.72) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 3.325 -8.72) (pt -9.325 -8.72) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -9.325 -8.72) (pt -9.325 3.52) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 3.325 3.52) (pt 3.325 -8.72) (width 0.127))
		)
		(layerContents (layerNumRef 18)
			(line (pt 3.325 -8.72) (pt -9.325 -8.72) (width 0.127))
		)
		(layerContents (layerNumRef 18)
			(line (pt -9.325 -8.72) (pt -9.325 3.52) (width 0.127))
		)
		(layerContents (layerNumRef 18)
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -10.595 4.9792) (pt 4.595 4.9792) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 4.595 4.9792) (pt 4.595 -9.99) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 4.595 -9.99) (pt -10.595 -9.99) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -10.595 -9.99) (pt -10.595 4.9792) (width 0.05))
		)
	)
	(symbolDef "43045-0600" (originalName "43045-0600")
	...
	(compDef "43045-0600" (originalName "43045-0600") (compHeader (numPins 6) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "43045-0600"))
		(attachedPattern (patternNum 1) (patternName "43045-06(00,01,02,10)")
			(numPads 6)
			(padPinMap
		...
		(attr "Mouser Part Number" "538-43045-0600")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Molex/43045-0600?qs=mrPiglD9aYJ8CzJ%2FE2PNbw%3D%3D")
		(attr "Manufacturer_Name" "Molex")
		(attr "Manufacturer_Part_Number" "43045-0600")
		(attr "Description" "Micro-Fit 3.0 Right-Angle Header, 3.00mm Pitch, Dual Row, 6 Circuits, with Snap-in Plastic Peg PCB Lock")
		(attr "<Hyperlink>" "https://www.molex.com/pdm_docs/sd/430450200_sd.pdf")
		(attr "<Component Height>" "9.9")
		(attr "<STEP Filename>" "43045-0600.stp")
		(attr "<STEP Offsets>" "X=-3.01;Y=-3.94;Z=3.86")
