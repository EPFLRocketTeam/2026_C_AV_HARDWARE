...
(library Library_1
	...
	(symbolDef "MCP602-E_SN" (originalName "MCP602-E_SN")
	...
	(compDef "MCP602-E_SN" (originalName "MCP602-E_SN") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "MCP602-E_SN"))
		...
		(attr "Mouser Part Number" "579-MCP602-E/SN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Microchip-Technology/MCP602-E-SN?qs=iRhCjdSJZe6hCMMETMefXQ%3D%3D")
		(attr "Manufacturer_Name" "Microchip")
		(attr "Manufacturer_Part_Number" "MCP602-E/SN")
		(attr "Description" "Microchip MCP602-E/SN, Dual Op Amp, 2.8MHz Rail-Rail, 2.7  6 V, 8-Pin SOIC")
		(attr "<Hyperlink>" "https://www.mouser.in/datasheet/2/268/21314g-2449592.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "MCP602-E_SN.stp")
		(attr "<STEP Offsets>" "X=0;Y=0.02;Z=0.96")
