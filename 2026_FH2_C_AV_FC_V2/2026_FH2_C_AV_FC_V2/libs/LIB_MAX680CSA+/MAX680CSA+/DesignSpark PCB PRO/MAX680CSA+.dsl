...
(library Library_1
	...
	(compDef "MAX680CSA+" (originalName "MAX680CSA+") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "C1+") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-18/DSA-340121.pdf")
		(attr "Height" "1.75 mm")
	)
