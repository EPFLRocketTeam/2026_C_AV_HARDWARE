...
(library Library_1
	...
	(symbolDef "PTVS30VS1UR_115" (originalName "PTVS30VS1UR_115")
	...
	(compDef "PTVS30VS1UR,115" (originalName "PTVS30VS1UR,115") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "PTVS30VS1UR_115"))
		...
		(attr "Mouser Part Number" "771-PTVS30VS1UR115")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Nexperia/PTVS30VS1UR115?qs=GcY6OjH1zdkc%252BCtbt7xiQQ%3D%3D")
		(attr "Manufacturer_Name" "Nexperia")
		(attr "Manufacturer_Part_Number" "PTVS30VS1UR,115")
		(attr "Description" "TVS Diodes - Transient Voltage Suppressors TVS UNI-DIR 30V 400W")
		(attr "<Hyperlink>" "https://assets.nexperia.com/documents/data-sheet/PTVSXS1UR_SER.pdf")
		(attr "<STEP Filename>" "PTVS30VS1UR,115.stp")
		(attr "<STEP Offsets>" "X=-1.27;Y=1.97;Z=-1.23")
