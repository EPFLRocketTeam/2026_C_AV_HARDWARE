...
(library Library_1
	...
	(symbolDef "INA228AIDGSR" (originalName "INA228AIDGSR")
	...
	(compDef "INA228AIDGSR" (originalName "INA228AIDGSR") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "INA228AIDGSR"))
		...
		(attr "Mouser Part Number" "595-INA228AIDGSR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/INA228AIDGSR?qs=pUKx8fyJudB2qGvt%252BmXPAg%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "INA228AIDGSR")
		(attr "Description" "Current & Power Monitors & Regulators 85-V, 20-bit, ultra-precise, I2C output current/voltage/power/energy/charge monitor with alert</p")
		(attr "Datasheet Link" "https://www.ti.com/general/docs/suppproductinfo.tsp?distId=10&gotoUrl=http%3A%2F%2Fwww.ti.com%2Flit%2Fgpn%2Fina228")
		(attr "Height" "1.1 mm")
	)
