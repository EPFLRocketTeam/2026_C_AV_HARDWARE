...
(library Library_1
	...
	(symbolDef "EEH-ZA1V680XP" (originalName "EEH-ZA1V680XP")
	...
	(compDef "EEH-ZA1V680XP" (originalName "EEH-ZA1V680XP") (compHeader (numPins 2) (numParts 1) (refDesPrefix C)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "EEH-ZA1V680XP"))
		...
		(attr "Mouser Part Number" "667-EEH-ZA1V680XP")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Panasonic/EEH-ZA1V680XP?qs=7UCyOFMWVHavYMOgLABudw%3D%3D")
		(attr "Manufacturer_Name" "Panasonic")
		(attr "Manufacturer_Part_Number" "EEH-ZA1V680XP")
		(attr "Description" "Aluminum Organic Polymer Capacitors 68uF 35volt AEC-Q200")
		(attr "<Hyperlink>" "http://industrial.panasonic.com/cdbs/www-data/pdf/RDD0000/ABA0000C1221.pdf")
		(attr "<Component Height>" "8.3")
		(attr "<STEP Filename>" "EEH-ZA1V680XP.stp")
